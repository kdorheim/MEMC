...
usethis::use_data(x = MEND_params, overwrite = TRUE)
...
usethis::use_data(x = MEND_initalState, overwrite = TRUE)


# 2 Pool MEND  -----------------------------------------------------------------------------------------
# Citation?
MEND2_params <- read.csv(file.path(DIR, "MEND2_params.csv"), stringsAsFactors = FALSE)
usethis::use_data(x = MEND2_params, overwrite = TRUE)
...
usethis::use_data(x = MEND2_initalState, overwrite = TRUE)
