...
is a system of differential equations that describe soil carbon dynamics. There are 8 different carbon pools represented as the circles that are connected by 12 arrows, which represent the fluxes between carbon pools. 
...
Start out by defining the initial sizes of the carbon pools. 
...
```{r}
MEND2013_example1 <- MEND2013(parameters = MEND2013_params, time = t, inital_state = state)
```
